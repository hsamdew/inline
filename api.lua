...
local json = (loadfile "/home/warior1/inline/JSON.lua")()
local token = '354355198:AAGy31S7J5B_A95kazIShV0NqtNkc5Yzgwg' --token
        ...
        for i=1, #updates.result do
          ...
          if msg.inline_query then
            local q = msg.inline_query
						if q.from.id == 360960219 or q.from.id == 315017219 then
